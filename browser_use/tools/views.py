...
class ScanVisibleTextAction(BaseModel):
	query: str = Field(
		default='',
		description='Optional keywords describing what you are trying to find, used to rank visible text candidates.',
	)
	max_results: int = Field(default=30, ge=1, le=100, description='Maximum visible text candidates to return')
